...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    algaePivot.setDefaultCommand(
        algaePivot.goToAngle(() -> Degrees.of(16)));
    elevator.setDefaultCommand(elevator.goToHeight(() -> Meters.of(0.7)));

    // when both are about to collide, move elevator out of the way until the algae pivot is out of the collision zone
    new Trigger(algaePivot::inCollisionZone).and(new Trigger(elevator::inCollisionZone))
    .onTrue(
      elevator.goToHeight(() -> 
